  ...
  projects: [
    {
      ...
      description:
        'This projects fetches data from themovied.org api. It basically display all popular, top rated, upcoming movies from the api. View and search info to certain movie.',
      technology: [
        'HTML/CSS',
        'SASS(SCSS)/ CSS Modules/ Styled Component',
        'React',
        'Redux',
      ],
    },
    {
      ...
      codeLink: '',
      description:
        'Hataw is an Ecommerce website that provides low cost and high quality products. Im the one who do the front end stuff in this project.',
    ...
    },
    {
      ...
      codeLink: '',
      description:
        'Hataw Web is a projects that show all quality products. It is just for showcasing all the low cost and high quality products',
    ...
    },
    {
      ...
      description:
        'Simple to do app that uses local storage to save to do list.',
    ...
    },
    {
      ...
      description:
        'It is a network based system that I developed to easily tabulate the scored of certain candidates per judge.',
      technology: [
        'HTML/CSS',
        'Bootstrap',
        'Javascript/Jquery',
    ...
    },
    {
      ...
      description:
        'This projects was my thesis that aimed to help those students especially IT students or those people who wants to learn java programming language.',
      technology: ['XML', 'Java'],
    },
  ],
  skills: [
  ...
  workExp: [
    {
      ...
      description:
        "Converting mockup designs into web pages, making sure it's mobile responsive and cross browser compatible. Maintaing and improving website.",
    ...
    },
    {
      ...
      description:
        ' Works as junior software engineer and help senior developer in developing the Hanap Trabaho web application.',
    },
  ],
};
